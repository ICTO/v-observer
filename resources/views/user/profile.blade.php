                ...
                <div class="card left-align">
                    <div class="card-content">
                        <div class="row">
                            ...
                            <div class="col s4">
                                <img src="/images/no_avatar.png" alt="" class="circle responsive-img">
                            </div>
                        </div>
                    </div>
                    <div class="card-action">
                        <a class="waves-effect waves-light btn white-text" href="{{ action('User\ProfileController@getEditProfile') }}"><i class="material-icons left">mode_edit</i>Edit</a>
                    </div>
                </div>
            </div>
        </div>
