        ...
        <div class="row">
            <div class="col s12 m8 push-m2 l6 push-l3">
                <div class="card left-align">
                    <form method="POST" action="{{ action('Observation\QuestionaireController@postEditQuestionaire', $questionaire->id) }}">
                        {!! csrf_field() !!}
                        <div class="card-content">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input type="text" name="name" value="{{ old('name') ? old('name') : $questionaire->name }}">
