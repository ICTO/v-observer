            ...
            <div class="col s12">
                <div class="card left-align">
                    ...
                    <div class="card-action">
                        ...
                        <a class="waves-effect waves-light btn white-text" href="{{ action('Observation\ObservationController@getBlocks', $questionaire->id) }}"><i class="material-icons left">assignment</i>Questions</a>
                        @endcan
